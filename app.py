...
ui_langs = {
    "🇰🇷 한국어": {
        ...
        "vision_title": "🛰️ Future Mission: 글로벌 표준 데이터화", "vision_desc": "글로벌 15개 육상 종목의 데이터를 구글 AR 안경에 투사하는 파운데이션 플랫폼입니다.", "f_title": "🧪 AI 연구소 & 비즈니스 컨택", "f_desc": "ATHLETICS AI의 발전을 위해 여러분의 피드백이 필요합니다. 아래 이메일로 보내주세요.", "btn_email": "📧 대표 이메일로 피드백 보내기"
    },
    "🇺🇸 English": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "Projecting global athletics data into AR glasses.", "f_title": "🧪 AI Lab & Contact", "f_desc": "Send us your feedback to upgrade the AI.", "btn_email": "📧 Send Feedback via Email"
    },
    "🇯🇵 日本語": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "世界の陸上データをARグラスに投影するプラットフォーム。", "f_title": "🧪 AI研究所 & お問い合わせ", "f_desc": "フィードバックをお願いします。", "btn_email": "📧 代表にメールを送る"
    },
    "🇨🇳 中文": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "将田径数据投射到AR眼镜的平台。", "f_title": "🧪 AI 实验室 & 合作咨询", "f_desc": "期待您的反馈。", "btn_email": "📧 发送邮件联系我们"
    },
    "🇪🇸 Español": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "Proyectando datos a gafas AR.", "f_title": "🧪 Laboratorio AI y Contacto", "f_desc": "Deja tus comentarios.", "btn_email": "📧 Enviar Comentarios por Email"
    },
    "🇮🇳 हिन्दी (Hindi)": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "एआर चश्मे में वैश्विक डेटा पेश करना।", "f_title": "🧪 AI लैब और संपर्क", "f_desc": "अपनी प्रतिक्रिया दें।", "btn_email": "📧 ईमेल के माध्यम से सुझाव भेजें"
    },
    "🇫🇷 Français": {
        ...
        "vision_title": "🛰️ Future Mission", "vision_desc": "Projection de données mondiales dans des lunettes AR.", "f_title": "🧪 Laboratoire AI & Contact", "f_desc": "Laissez vos commentaires.", "btn_email": "📧 Envoyer un Feedback par Email"
    }
}

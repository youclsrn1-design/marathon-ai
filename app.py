...
SPORT_MASTER_DB = {
    ...
    "라켓 스포츠": {
        ...
        "배드민턴/탁구": {
            ...
            "출처": "BWF/ITTF Manual", "풀이": "기마 자세와 높은 타점 유지가 라켓 스포츠의 핵심입니다.", "해결": "무릎을 낮추고 스윙 궤적을 크게 가져가세요."
        }
    },
    "수영/무도/야구": {
        "수영 (4대 영법)": {
            ...
            "출처": "FINA Standards", "풀이": "팔꿈치를 높게 유지해야 물을 효율적으로 뒤로 밀 수 있습니다.", "해결": "손목보다 팔꿈치를 높게 유지하며 물을 미세요."
        },
        "야구 (투구/타격)": {
...
uploaded_file = st.file_uploader("영상을 업로드하세요. 실시간 분석을 시작합니다.", type=["mp4", "mov", "avi"])
...
if uploaded_file is not None:
    ...
    while cap.isOpened():
        ...
        status_text.text(f"🏃‍♂️ {sub_cat} 분석 중... 실시간 데이터: {curr_angle if data_list else 0}°")
